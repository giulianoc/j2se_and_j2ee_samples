...
public class BookService {
    ...
    //  http://127.0.0.1:8080/webservicesTomcat-rest/rest/bookservice/status
	...
	public BookService(String persistenceUnit) {
        mLogger.error("Persistence.createEntityManagerFactory: " + persistenceUnit);

		entityManagerFactory = Persistence.createEntityManagerFactory(persistenceUnit);

        mLogger.error("entityManagerFactory.createEntityManager");
