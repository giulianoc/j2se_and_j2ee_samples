 ...
 * generated in the com.ejb.credit package. 
...
public class ObjectFactory {
    ...
    private final static QName _CreditCheck_QNAME = new QName("http://localhost:8080/ejb/credit", "CreditCheck");
    private final static QName _CreditCheckResponse_QNAME = new QName("http://localhost:8080/ejb/credit", "CreditCheckResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ejb.credit
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8080/ejb/credit", name = "CreditCheck")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://localhost:8080/ejb/credit", name = "CreditCheckResponse")
